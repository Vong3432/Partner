...
export const showProfile = id => (dispatch, getState) => {
    ...
    axios
        ...
        */
        .get(`/api/profile/getProfile/${id}`, tokenConfig(getState))        
        .then( res => 
            dispatch({
                type: SHOW_PROFILE,
                payload: res.data
...
export const editProfile = id => (dispatch, getState) => {
    axios
        ...
        */
        .put(`/api/profile/editProfile/${id}`, tokenConfig(getState))
        .then(res => 
                dispatch({
                    type: EDIT_PROFILE,
                    payload: res.data                    
...
export const deactiveProfile = id => (dispatch, getState) => {
    axios
        ...
        .delete(`/api/profile/deactiveProfile/${id}`, tokenConfig(getState))
        .then(res => {
            dispatch({
